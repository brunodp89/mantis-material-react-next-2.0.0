      ...
      <Grid container spacing={3}>
        {userCard.length > 0 ? (
          _DATA
            .currentData()
            .sort(function (a, b) {
              if (sortBy === 'Nome do Cliente') return a.fatherName.localeCompare(b.fatherName);
              if (sortBy === 'Email') return a.email.localeCompare(b.email);
              if (sortBy === 'Contato') return a.contact.localeCompare(b.contact);
              if (sortBy === 'Idade') return b.age < a.age ? 1 : -1;
              if (sortBy === 'País') return a.country.localeCompare(b.country);
          ...
          <EmptyUserCard title={'Ainda não criou nenhum cliente.'} />
        )}
      </Grid>
