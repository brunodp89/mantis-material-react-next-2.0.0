...
const ContactCell = ({ value }) => <NumberFormat displayType="text" format="+55 (##) #####-####" mask="_" defaultValue={value} />;
...
const StatusCell = ({ value }) => {
  switch (value) {
    case 'Complicated':
      return <Chip color="error" label="Rejeitado" size="small" variant="light" />;
    case 'Relationship':
      return <Chip color="success" label="Verificado" size="small" variant="light" />;
    case 'Single':
    default:
      return <Chip color="info" label="Pendente" size="small" variant="light" />;
  }
};
