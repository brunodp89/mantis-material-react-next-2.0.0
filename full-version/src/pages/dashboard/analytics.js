...
const DashboardAnalytics = () => {
  ...
  return (
    <Page title="Dashboard Analítico">
      <Grid container rowSpacing={4.5} columnSpacing={3}>
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticsDataCard title="Quantidade de máquinas" count="700">
            <UsersCardChart />
          </AnalyticsDataCard>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticsDataCard title="Máquinas ativas" count="200" isLoss color="warning">
            <OrdersCardChart />
          </AnalyticsDataCard>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticsDataCard title="Máquinas paradas" count="300" isLoss color="warning">
            <SalesCardChart />
          </AnalyticsDataCard>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticsDataCard title="Máquinas a retirar" count="100">
            <MarketingCardChart />
          </AnalyticsDataCard>
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticsDataCard title="Máquinas em estoque" count="100">
            <UsersCardChart />
          </AnalyticsDataCard>
        </Grid>
        ...
        <Grid item xs={12} md={7} lg={8}>
          <Grid container alignItems="center" justifyContent="space-between">
            <Grid item>
              <Typography variant="h5">Total de máquinas</Typography>
            </Grid>
          </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <Stack sx={{ ml: 2, mt: 3 }} alignItems={{ xs: 'center', sm: 'flex-start' }}>
                    <Stack direction="row" alignItems="center">
                      ...
                      <Typography color={theme.palette.error.main}>1275</Typography>
                    </Stack>
